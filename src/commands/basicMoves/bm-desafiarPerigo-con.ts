...
export const bmDesafiarPerigoC: Command = {
    data: new SlashCommandBuilder()
        .setName("desafiarcon")
        .setDescription("Realizar o movimento básico Desafiar o Perigo (Constituição).")
    ...
    run: async (interaction) => {
        ...
        const moveResult = new EmbedBuilder()
            .setTitle("Desafiar o Pergio (Constituição)")
